...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("CareerCoins"));
    case mBTC: return QString(QObject::tr("Milli-CareerCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-CareerCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
