...
unsigned int nStakeMinAge = 2* 24 * nOneHour; // 2days as zero time weight
unsigned int nStakeMaxAge = 8 * 24 * nOneHour; // 8days as full weight
...
const string strMessageMagic = "CareerCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("CareerCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CareerCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // CareerCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CareerCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CAR genesis";
        CTransaction txNew;
        ...
        block.nNonce   = 7017017; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb5, 0xf2, 0xe6, 0xe1 };
