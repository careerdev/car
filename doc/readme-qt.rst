TheChiefCoin-qt: Qt4 GUI for TheChiefCoin
===============================
...
Alternatively, install Qt Creator and open the `TheChiefCoin-qt.pro` file.

An executable named `TheChiefCoin-qt` will be built.
...
A warning for people using the *static binary* version of TheChiefCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of TheChiefCoin is linked against libdb5.3.
...
installed causes TheChiefCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
